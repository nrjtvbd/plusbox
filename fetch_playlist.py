...
PLAYLIST_FILENAME = "playlist.m3u" # নিশ্চিত করলাম এই নামটাই থাকবে
MAX_WORKERS = 2 
...
def main():
    ...
    if playlist_entries:
        ...
        print("No tokens found. Creating an empty file to avoid Git error.")
        with open(PLAYLIST_FILENAME, "w") as f:
            f.write("#EXTM3U\n# No tokens found during last update")
